...
def main():
    ...
    # Predict the class for the entire test set
    ...
    # Perform classification for a single test vector (e.g., the first test vector)
    test_vect = X_test[0]
    predicted_class = knn_classifier.predict([test_vect])

    # Print the result for the single test vector
